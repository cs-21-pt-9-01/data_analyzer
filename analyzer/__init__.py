...
from .microservice_docker import micro_docker_run
...
graphs = ['grouped_barchart', 'power_j_total', 'power_j_avg', 'power_curve', 'docker_plot_micro', 'docker_plot_mono']
...
def run():
    ...
    elif args.graph == 'docker_plot_mono':
        docker_run(args.input, args.output, args.title)
    elif args.graph == 'docker_plot_micro':
